...
urlpatterns = [
    ...
    path('employers/profile/logo/upload/', views.company_logo_upload, name='company_logo_upload'),
    path('employers/profile/logo/remove/', views.company_logo_remove, name='company_logo_remove'),
